  ...
  return (
    <>
      ...
      >
        ...
        {sidebarOpen && (
          <div
            className="sm:hidden fixed inset-0 bg-gray-800 bg-opacity-75 z-50 flex justify-end transition-opacity duration-300 animate-in fade-in"
            onClick={toggleSidebar}
          >
            <div
              ref={sidebarRef}
              className="bg-secondary w-[80vw] p-4 flex flex-col h-full rounded-l transform transition-transform duration-300 ease-out animate-in slide-in-from-right"
